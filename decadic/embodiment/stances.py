...
STANCES: dict[str, Stance] = {
    ...
    "crawl": Stance(
        name="crawl",
        label="Crawl (motion)",
        description="Looping diagonal quadruped gait on hands and knees with propulsive reach/push phases.",
        joints=_ALL_FOURS_JOINTS,
        root_z=0.47,
        root_quat=_pitch_quat(90.0),
        fall_z=0.25,
